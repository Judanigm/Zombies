...
@export var corpse_duration: float = 0.75
@export var spawn_duration: float = 1.25
@export var spawn_shake_distance: float = 16.0
@export var spawn_shake_speed: float = 42.0
...
static func _get_sprite_frames() -> SpriteFrames:
	...
	_add_strip_animation(frames, WALK_DOWN_ANIMATION, WALK_DOWN_TEXTURE, 13.0)
	_add_strip_animation(frames, WALK_UP_ANIMATION, WALK_UP_TEXTURE, 13.0)
	_add_strip_animation(frames, WALK_RIGHT_ANIMATION, WALK_RIGHT_TEXTURE, 13.0)
	_add_strip_animation(frames, WALK_LEFT_ANIMATION, WALK_LEFT_TEXTURE, 13.0)
